public class Exercicio011MetodosCalculadora {
    ...
    public static void sum(double number1, double number2) {
        ...
        System.out.println("The result between " + number1 + " + " + number2 + " = " + result);
    ...
    public static void multiplication(double number1, double number2) {
        ...
        System.out.println("The result between " + number1 + " x " + number2 + " = " + result);
